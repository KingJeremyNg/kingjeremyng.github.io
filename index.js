(function () {
    ...
    render = function () {
        ...
        // Draw the Sheep
        buffer.drawImage(sprite_sheet.image, player.animation.frame * SPRITE_WIDTH, 0, SPRITE_WIDTH, SPRITE_HEIGHT, Math.floor(player.x), Math.floor(player.y), SPRITE_WIDTH * SCALE, SPRITE_HEIGHT * SCALE);
